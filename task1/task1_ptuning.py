...
if not os.path.exists(path_file_name):
    ...
    fileObject.write(
        "ptuning" + " dev accuracy is " + str(hit / all) + " dev evaluate " + str(all) + " tp " + str(tp) + ' tn ' + str(tn) + " fp " + str(fp) + " fn " + str(fn)
    )
    fileObject.write('\n')
    fileObject.close()
else:
...
print('finish test')
torch.save(model, str(args.lr) + " " + str(args.epochs) + "negative" + str(args.negative_size) + " test_task1_ptuning_checkpoint_s1.pkl")

path_file_name ='/home/zijian/Scripts_new/result/task1.txt'
if not os.path.exists(path_file_name):
    fileObject = open(path_file_name, 'a+', encoding='utf-8')
    fileObject.write(
        "test_ptuning" + " test accuracy is " + str(hit / all) + " test evaluate " + str(all) + " tp " + str(tp) + ' tn ' + str(tn) + " fp " + str(fp) + " fn " + str(fn)
    )
    fileObject.write('\n')
    fileObject.close()
else:
    ...
    fileObject.write(
        "test_ptuning" + " test accuracy is " + str(hit / all) + " test evaluate " + str(all) + " tp " + str(
            tp) + ' tn ' + str(tn) + " fp " + str(fp) + " fn " + str(fn) + "negative_size" + str(args.negative_sze)
    )
    fileObject.write('\n')
    fileObject.close()