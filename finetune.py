...
with open('/home/zijian/scripts_learning/dataset/atomic/event_center/after.txt', 'r') as f:
    dataset = f.read()
...
for i in range(epoch):
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        loss, logits = model(data, labels=target)[0],  model(data, labels=target)[1]
...
text = "John has a huge party after"  # 这里也可以输入不同的英文文本
